...
```js
import { Web6Client } from 'https://esm.sh/@oasisomniverse/web6-api@1.0.3';
const client = new Web6Client({ baseUrl: 'https://api.web6.oasisomniverse.one' });
```
...
const client = new Web6Client({ baseUrl: '...', fetchImpl: fetch });
```
